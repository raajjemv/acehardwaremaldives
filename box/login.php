...
if ($_POST['login'])
{
	...
	if(mysql_num_rows($result) > 0) {
		...
		//$success_login = '<meta http-equiv="refresh" content="3;url=' . $redirect_url .'"><div class="alert alert-success" style="text-align:left"><i class="icon-ok-sign"></i>Login Successful. Redirecting to CMS...</div>';
		$success_login = '<meta http-equiv="refresh" content="3;url=' . $redirect_url .'"><script type="text/javascript">timeleft = 4; setInterval(function(){ timeleft--; document.getElementById("timeleft").innerHTML = timeleft; }, 1000); </script><div class="alert alert-success" style="text-align:left"><i class="icon-ok-sign"></i>Login Successful. Redirecting in <span id="timeleft">4</span> secs</div>';
	}else{
...
<div class="row-fluid login-wrapper">
    ...
    <div class="span4 no-account">
        <p>&copy; 2013 box cms by Meemoinc Pvt Ltd. Version 1.0.1</p>
    </div>
</div>
