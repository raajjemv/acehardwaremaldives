...
if($host[1] == '8888'){
	...
	$db_hostname 	= "internal-db.s181037.gridserver.com";
	$db_port 		= "";
	$db_username 	= "db181037";
	$db_password 	= "8THjH4grfiMZPm";
	$db_name 		= "db181037_boxcms";
	$wwwroot 		 = "http://acehardwaremaldives.com/box_";
