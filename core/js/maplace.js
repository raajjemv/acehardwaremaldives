		...
		Maplace.prototype.type_to_open = {
			...
			bubble: function (location) {
				this.infowindow = new google.maps.InfoWindow({
                    ...
                    // html2: { title: "Alimatha", code: "ALM", position: "Vaavu Atoll", coordinates: "N 03° 35.28' / E 073° 30.04'", license: "AP/O/63", ldate: "31/12/2013", moreinfo: '' }
//                    content:    '<table class="map_info">' + 
//                                    '<tr><td colspan="2" class="head">' + location.html2.title + '</td></tr>' + 
//                                    '<tr><td class="title">Code</td><td>' + location.html2.code + '</td></tr>' + 
//                                    '<tr><td class="title">Proximity</td><td>' + location.html2.position + '</td></tr>' + 
//                                    '<tr><td class="title">Coordinates</td><td>' + location.html2.coordinates+ '</td></tr>' + 
//                                    '<tr><td class="title">License No.</td><td>' + location.html2.license + '</td></tr>' + 
//                                    '<tr><td class="title">License Date</td><td>' + location.html2.ldate+ '</td></tr>' +
//                                    '<tr><td></td><td>' + location.html2.moreinfo + '</td></tr>' +
//                                '</table>' || ''
				});
			}
		};
