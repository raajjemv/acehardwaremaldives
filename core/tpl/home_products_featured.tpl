<div class="row">
	<?php for ($i = 0; $i < 4; $i++) { ?>
	<?php 
	$product_id = $featured_products->{'products'}[$i]->{'product_id'}; 
	$product_name = get_product_info($featured_products->{'products'}[$i]->{'product_id'}, "name"); 
	$product_parent_category = get_product_info($featured_products->{'products'}[$i]->{'product_id'}, "parent_category");
	$product_child_category_1 = get_product_info($featured_products->{'products'}[$i]->{'product_id'}, "child_category_1"); 
	$product_child_category_2 = get_product_info($featured_products->{'products'}[$i]->{'product_id'}, "child_category_2"); 
	?>
	<div class="col-xs-3">
		...
		<div class="products">
			<div class="thumbs">
				...
				<a href="#" class="quickview entypo-layout show-quick-view" data-product-id="<?php echo $featured_products->{'products'}[$i]->{'product_id'} ?>">Quick View</a>
